...
const Content: React.FC = () => {
  return (
    <div>
      ...
      <div className="hidden md:block pt-16 pb-24 px-28">
        ...
        <div className="flex">
          ...
          <div className="flex flex-col pr-10">
            ...
            <Button className="text-xl w-44 px-4 py-6" color="primary" radius="none" variant="ghost" endContent={<RocketLaunchIcon />}>
              Go Blog
            </Button>
          </div>
        </div>
      ...
      {/* md以下 */}
      <div className="md:hidden pt-10 pb-20 pl-10 pr-7">
        <H2 text="Content" />
