  ...
  return (
    <div>
      ...
      <div className="hidden md:block py-16 px-28">
        ...
        <div data-aos="fade-in" data-aos-offset="250">
          <SkillSet colorType="yellow" icon={<PyIcon />} text1="Backend" text2="Python" text3="SQL" text4="Generative AI" text5="NoSQLやGenerativeAIなどのトレンド技術を使用します" />
        </div>
        <div data-aos="fade-in" data-aos-offset="250">
      ...
      <div className="md:hidden justify-bottom py-10 px-10">
        ...
        <div data-aos="fade-in" data-aos-offset="100">
          <SkillSet2 colorType="yellow" icon={<PyIcon />} text1="Backend" text2="Python" text3="SQL" text4="Generative AI" text5="NoSQLやGenerativeAIなどのトレンド技術を使用します" />
        </div>
        <div data-aos="fade-in" data-aos-offset="100">
